...
class Training extends MY_Controller {
	...
	public function index()
  {
		...
		if(in_array('49',role_resource_ids())) {
  ...
  public function training_list()
  {
        ...
        foreach($training->result() as $r) {
			...
			// status
			if($r->training_status==0): $status = '<span class="label label-warning">Pending</span>';
			elseif($r->training_status==1): $status = '<span class="label label-info">Started</span>'; elseif($r->training_status==2): $status = '<span class="label label-success">Completed</span>';
			else: $status = '<span class="label label-danger">Terminated</span>'; endif;
			...
			$data[] = array(
				...
				$training_cost,
				$status,
				'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data"  data-training_id="'. $r->training_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a href="'.site_url().'training/details/'.$r->training_id.'/"><i class="icon-eye4"></i> View Details</a></li><li><a class="delete" href="#" data-record-id="'. $r->training_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
			);
        }
	...
	public function details()
  {
		...
		$data['breadcrumbs'] = 'Training Details';
