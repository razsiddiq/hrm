	...
	public function index()
     {
		...
		if(in_array('50',role_resource_ids())) {
    ...
    public function type_list()
     {
		...
		$data[] = array(
			...
			$r->training_type_id,
			$r->type,
			'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data-md"  data-training_type_id="'. $r->training_type_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a class="delete" href="#" data-record-id="'. $r->training_type_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
		);
      }
