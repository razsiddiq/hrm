...
class Job_interviews extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('47',role_resource_ids())) {
			if(!empty($session)){ 
    ...
    public function interview_list()
     {
		...
		$data[] = array(
			...
			$interviewers,
			$int_addedby,
			'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a class="delete" href="#" data-record-id="'. $r->job_interview_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
		);
      }
