...
class Expense extends MY_Controller {
	...
	public function index()
  {
		...
		if(in_array('10',role_resource_ids())) {
	...
	public function expense_list()
  {
    ...
    foreach($expense->result() as $r) {			  
			  ...
			  if($r->status==0): $status = '<span class="label label-warning">Pending</span>'; elseif($r->status==1): $status = '<span class="label label-success">Approved</span>'; else: $status = '<span class="label label-danger">Cancel</span>'; endif;
			  if($r->billcopy_file!='' && $r->billcopy_file!='no file') {
				...
				$data[] = array(
						...
						$full_name,
						$expense_type[0]->type_name,
						$currency,
						$edate,
						$status,
						'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data"  data-expense_id="'. $r->expense_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a href="#" data-toggle="modal" data-target=".view-modal-data" data-expense_id="'. $r->expense_id . '"><i class="icon-eye4"></i> View</a></li><li><a class="delete" href="#" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->expense_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
        );
    }
