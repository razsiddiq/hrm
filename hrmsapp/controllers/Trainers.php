...
class Trainers extends MY_Controller {
	...
	public function index()
  {
		...
		if(in_array('51',role_resource_ids())) {
  ...
  public function trainer_list()
  {
    ...
    foreach($trainers->result() as $r) {			 			  
			...
			// get name
			$full_name = change_fletter_caps($r->first_name);
			...
			$data[] = array(
				...
				'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data"  data-trainer_id="'. $r->trainer_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a data-toggle="modal" data-target=".view-modal-data" data-trainer_id="'. $r->trainer_id . '"><i class="icon-eye4"></i> View Details</a></li><li><a class="delete" href="#" data-record-id="'. $r->trainer_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
			);
    }
