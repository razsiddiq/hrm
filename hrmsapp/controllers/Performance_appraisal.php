 ...
 * @Author Siddiqkhan
 *
 * @PerformanceAppraisal Controller
 */
...
class Performance_appraisal extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('25',role_resource_ids())) {
			if(!empty($session)){ 
    ...
    public function appraisal_list()
     {
		...
		$data[] = array(
			...
			$ap_date,
			'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data"  data-performance_appraisal_id="'. $r->performance_appraisal_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a href="#" data-toggle="modal" data-target=".view-modal-data" data-p_appraisal_id="'. $r->performance_appraisal_id . '"><i class="icon-eye4"></i> View</a></li><li><a class="delete" href="#" data-record-id="'. $r->performance_appraisal_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
		);
      }
	 ...
	 public function read()
	{
		...
		$data = array(
				...
				'appraisal_year_month' => date('Y-m',strtotime($result[0]->appraisal_year_month)),
	...
	public function add_appraisal() {
		...
		'appraisal_year_month' => date('Y-m',strtotime($this->input->post('month_year'))),
