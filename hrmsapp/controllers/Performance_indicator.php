 ...
 * @Author Siddiqkhan
 *
 * @PerformanceIndicator Controller
 */
...
class Performance_indicator extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('24',role_resource_ids())) {
			if(!empty($session)){ 
    ...
    public function performance_indicator_list()
     {
		...
		$data[] = array(
			...
			$full_name,
			$created_at,
'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data"  data-performance_indicator_id="'. $r->performance_indicator_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a href="#" data-toggle="modal" data-target=".view-modal-data" data-p_indicator_id="'. $r->performance_indicator_id . '"><i class="icon-eye4"></i> View</a></li><li><a class="delete" href="#" data-record-id="'. $r->performance_indicator_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
		);
      }
