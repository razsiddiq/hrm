...
class Job_post extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('45',role_resource_ids())) {
			if(!empty($session)){ 
    ...
    public function job_list()
     {
		...
		$data[] = array(
			...
			$status,
			$created_at,
			'<ul class="icons-list"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu9"></i></a><ul class="dropdown-menu dropdown-menu-right"><li><a href="#" data-toggle="modal" data-target=".edit-modal-data"  data-job_id="'. $r->job_id . '"><i class="icon-pencil7"></i> Edit</a></li><li><a href="'.site_url().'frontend/jobs/detail/'.$r->job_id.'" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="icon-eye4"></i> View Details</a></li><li><a class="delete" href="#" data-record-id="'. $r->job_id . '"><i class="icon-trash"></i> Delete</a></li></ul></li></ul>',
		);
      }
