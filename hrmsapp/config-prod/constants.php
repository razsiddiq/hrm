...
define('TESTING_MAIL',FALSE);
define('FROM_MAIL','FQDN@mail.alifco.ae');
define('FROM_NAME','Awok.com HR');
define('TO_MAIL','sharoon.y@awok.ae');
...
define("MANAGER_LEVEL_DESIG", serialize (array ("manager")));
...
define('SMS_URL','https://www.smartsmsgateway.com/api/api_http.php?');
/*SMS Package*/
/*
|--------------------------------------------------------------------------
