        ...
        <div class="col-md-12">
          <div class="panel-body">
            <div class="form-group">
              ...
              <textarea class="form-control textarea" placeholder="Remarks" name="remarks" cols="30" rows="15" id="remarks2"><?php echo html_entity_decode(stripcslashes(
$remarks));?></textarea>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <div class="box box-block bg-white">
          <div class="form-group">
			...
			<br>
            <div class="text_area_p"><div class="embed-responsive embed-responsive-4by3"><?php echo html_entity_decode(stripcslashes($remarks));?> </div></div></div>
        </div>
      </div>
    </div>
  </div>
