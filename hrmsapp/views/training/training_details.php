    ...
    <table class="table table-striped m-md-b-0">
      <tbody>
		...
		<tr>
          ...
          <td class="text-right"><?php echo html_entity_decode(stripcslashes($description));?></td>
        </tr>
		  <?php endif;?>
      </tbody>
    </table>
...
<div class="wizard" role="tabpanel">
    	...
    	<div class="panel-heading">
							<h5 class="panel-title" style="margin-left: -8px;">
...
<div class="col-md-6">
       										  ...
       										  <ul class="media-list">
										<li class="media-header">Training Employee(s)</li>
                <?php if($employee_id!='') {?>
