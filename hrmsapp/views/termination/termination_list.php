...
<div class="add-form" style="display:none;">
   <div class="panel panel-flat">
  	<div class="panel-heading">
							...
							<strong><?php echo $this->lang->line('xin_add_new');?></strong> Termination
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
						...
						<div class="input-group date form_date" data-date="" data-date-format="dd MM yyyy"  data-link-format="yyyy-mm-dd">
                    <input class="form-control" placeholder="Termination Date" name="termination_date" size="16" type="text"  value="" readonly>
                    <span class="input-group-addon" ><span class="glyphicon glyphicon-remove"></span></span>					
                </div>
...
<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<strong><?php echo $this->lang->line('xin_list_all');?></strong> Terminations
