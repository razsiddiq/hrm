...
<?php if(in_array('31v',role_resource_ids())) {?>
				 ...
				 <div class="col-md-2">
                  <div class="form-group">
                    <select name="employee_id" id="user_id" class="form-control" data-plugin="select_hrm" data-placeholder="Choose an Employee...">
                      ...
                      <option value="<?php echo $employee->user_id;?>" <?php //if($session['user_id']==$employee->user_id):selected?>  <?php //endif;?>> <?php echo change_fletter_caps($employee->first_name.' '.$employee->middle_name.' '.$employee->last_name);?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
...
<div class="panel panel-flat">
					...
					<div class="heading-elements">
							 ...
							 <?php if($session['role_name']==AD_ROLE || in_array('31ad',role_resource_ids())) {?>
							...
							<?php } ?>
							  ...
							  <?php if(in_array('31d',role_resource_ids())) {?>
					...
					<?php if(in_array('31a',role_resource_ids())) {?>
					  <!--<div class="add-record-btn pull-right ml-10">    -->
