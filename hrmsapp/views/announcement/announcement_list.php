...
<div class="add-form" style="display:none;">
  	...
  	<div class="panel-heading">
							...
							<strong><?php echo $this->lang->line('xin_add_new');?></strong> <?php echo $this->lang->line('xin_announcement');?></strong>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="department" class="control-label"><?php echo $this->lang->line('xin_department');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" class="styled" id="checkbox_depart">&nbsp;&nbsp;Select All</label>
                        <select multiple class="form-control" name="department_id[]" data-plugin="select_hrm" data-placeholder="All Department<?php //echo $this->lang->line('xin_department');?>" id="depart_id">
...
<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<strong><?php echo $this->lang->line('xin_list_all');?></strong> <?php echo $this->lang->line('xin_announcements');?></strong>
