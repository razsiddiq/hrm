     ...
     <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_description');?>" name="description" cols="30" rows="15" id="description2"><?php echo html_entity_decode(stripcslashes($description));?></textarea>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" placeholder="<?php echo $this->lang->line('xin_summary');?>" name="summary" cols="30" rows="1" id="summary"><?php echo html_entity_decode(stripcslashes($summary));?></textarea>
                </div>
              </div>
            </div>
          <div class="row">
  ...
  <div class="modal-body">
     <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="description"><?php echo $this->lang->line('xin_description');?></label>
            <?php echo html_entity_decode(stripcslashes($description));?>
          </div>
        </div>
      </div>
      <div class="row">
