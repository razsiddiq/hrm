        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Month & Year of Award" readonly="true" name="month_year" type="text" id="<?php echo $fi;?>" value="<?php echo $award_month_year;?>">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class='form-group'>
          ...
          <input type="file" class="file-input1" name="award_picture" id="award_picture">
          ...
          <br />
          <img src="<?php echo base_url().'uploads/award/'.$award_photo;?>" width="70px" id="u_file">
          <a class="btn bg-teal-400" href="<?php echo site_url()?>download?type=award&filename=<?php echo $award_photo;?>"><i class="icon-download"></i> Download</a>
          <?php } else {?>
          <p>&nbsp;</p>
          <?php } ?>
        </div>
...
<script type="text/javascript">
 $(document).ready(function(){
	...
	$('[data-plugin="select_hrm"]').select2($(this).attr('data-options'));			
		...
		// Award Date
		$('.d_award_date').pickadate();
		// Award Month & Year
		
			$('#<?php echo $fi;?>').AnyTime_picker({
		format: "%Y %M"	
		});
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label for="description">Description</label>
        <br />
       <div class="text_area_p"> <div class="embed-responsive embed-responsive-4by3">
<?php echo html_entity_decode(stripcslashes($description));?> </div></div></div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-3">
