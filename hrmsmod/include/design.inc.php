...
<link rel="stylesheet" type="text/css" href="../hrmsmod/static/default.css">
<?php echo script_src("../hrmsmod/static/functions.js"); ?>
<?php echo script_src("static/editing.js"); ?>
<?php if ($adminer->head()) { ?>
<link rel="shortcut icon" type="image/x-icon" href="../hrmsmod/static/favicon.ico">
<link rel="apple-touch-icon" href="../hrmsmod/static/favicon.ico">
