...
$( document ).on( "click", ".delete", function() {
	...
	$("#checkbox_depart").click(function(){
    if($("#checkbox_depart").is(':checked') ){	
        $("#depart_id > option").prop("selected","selected");
        $("#depart_id").trigger("change");
    }else{	
        $("#depart_id > option").removeAttr("selected");
        $("#depart_id").val(0).trigger("change");
     }
});
