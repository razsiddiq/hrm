 ...
 *   https://datatables.net/download/#dt/b-1.2.1/b-colvis-1.2.1/b-flash-1.2.1/b-html5-1.2.1/b-print-1.2.1
 *
 * Included libraries:
 *   Buttons 1.2.1, Column visibility 1.2.1, Flash export 1.2.1, HTML5 export 1.2.1, Print view 1.2.1
 */
...
function(){});d("body").on("click.dtb-collection",function(a){
	...
	if(!d(a.target).parents().filter(e._collection).length){
		
		e._collection.fadeOut(e.fade,function(){e._collection.detach()});d("div.dt-button-background").off("click.dtb-collection");m.background(false,e.backgroundClassName,e.fade);d("body").off("click.dtb-collection");b.off("buttons-action.b-internal")
		
	}
	
	}

)},10);if(e.autoClose)b.on("buttons-action.b-internal",function(){d("div.dt-button-background").click()})},background:!0,collectionLayout:"",
